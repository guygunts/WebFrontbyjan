...
import {AppMenuComponent} from './pages/menu/app.menu.component';
...
import {MenuService} from './pages/menu/app.menu.service';
...
const config: SocketIoConfig = { url: 'http://0.0.0.0/SocketIo', options: {} };
@NgModule({
    imports: [
        BrowserModule,
        FormsModule,
    ...
    declarations: [
        ...
        InfomationComponent,
        BasicdriverComponent,
        PenaltyComponent,
        PropertyComponent,
        TechnicalComponent,
        TrafficComponent,
        TypedriverlicenseComponent,
        QuestionComponent,
        ExamComponent
    ],
    providers: [
        {provide: LocationStrategy, useClass: PathLocationStrategy},MenuService, AppBreadcrumbService],
